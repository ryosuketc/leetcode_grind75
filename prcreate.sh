...
echo "*C++ の経験が浅いので、問題のアルゴリズムよりは、C++ 言語仕様に関するコメントが多めです。多くの解き方を試すよりは、optimal な解法を C++ で書くとどうなるのか、といったスタンスで練習してみています。*"
...
echo "言語: C++"
echo
echo "最近解いた方が少ないので、個別 mention はしませんが、C++ レビューしてもいいよという方がいらしたらコメントいただけると嬉しいです。"
echo "*C++ の経験が浅いので、問題のアルゴリズムよりは、C++ 言語仕様に関するコメントが多めです。多くの解き方を試すよりは、optimal な解法を C++ で書くとどうなるのか、といったスタンスで練習してみています。*"
...
echo "言語: C++"
echo
echo "個別 mention はしませんが、C++ レビューしてもいいよという方がいらしたらコメントいただけると嬉しいです。"
echo "*C++ の経験が浅いので、問題のアルゴリズムよりは、C++ 言語仕様に関するコメントが多めです。多くの解き方を試すよりは、optimal な解法を C++ で書くとどうなるのか、といったスタンスで練習してみています。*"
